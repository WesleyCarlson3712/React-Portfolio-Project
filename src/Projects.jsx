          ...
          <Box sx={projectBox("column")}>
            <Box sx={textContainer}>
              ...
              <Typography>
                ...
                This project was my first time working with Arcade as well as my first tiem working with a hexagonal grid.
            ...
            <img src="/hex_game_screenshot.png" alt="Portfolio"/>
          </Box>
          <Box sx={projectBox("row")}>
            <img src="/journal_app_screenshot.png" alt="Portfolio"/>
            <Box sx={textContainer}>
